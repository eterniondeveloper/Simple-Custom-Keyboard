...
public final class User extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<KeyObject> keys;

  static {
    // hack to force ProGuard to consider KeyObject used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(KeyObject.class);
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<KeyObject> getKeys() {
    return keys;
  }
   ...
   */
  public User setKeys(java.util.List<KeyObject> keys) {
    this.keys = keys;
    return this;
  }
