...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param name
   * @param content the {@link com.example.konstantinos.myapplication.backend.myApi.model.User}
   * @return the request
   */
  public SayHi sayHi(java.lang.String name, com.example.konstantinos.myapplication.backend.myApi.model.User content) throws java.io.IOException {
    SayHi result = new SayHi(name, content);
    initialize(result);
    return result;
  }
  ...
  public class SayHi extends MyApiRequest<com.example.konstantinos.myapplication.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected SayHi(java.lang.String name, com.example.konstantinos.myapplication.backend.myApi.model.User content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.konstantinos.myapplication.backend.myApi.model.MyBean.class);
